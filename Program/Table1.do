*****
** TABLE 1 - Tilføjelse af CV til proportioner
*****
...
use Input/Total, clear
	...
	forvalues x = 1/6 {
		...
		gen prop_`x' = (100*Total$year`x'/Total$year 1)
		}
	egen mean=rmean(prop_2 prop_3 prop_4 prop_5 prop_6) 
	egen sd=rsd(prop_2 prop_3 prop_4 prop_5 prop_6)
	gen CV=sd/mean
...
joinby RegionNum using Input/Total
	...
	forvalues x = 1/6 {
		...
		gen prop_`x' = (100*TotalGender$year`x'/TotalTotal$year`x')
		}
	egen mean=rmean(prop_2 prop_3 prop_4 prop_5 prop_6) 
	egen sd=rsd(prop_2 prop_3 prop_4 prop_5 prop_6)
	gen CV=sd/mean
